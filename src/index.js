...
// in the i example we are going to make it so that the Teacher class is going to be able to inherit all of the methods from the Person class
class Person {
  constructor(name) {
    this.name = name;
  }
...
const teacher = new Teacher("Teagan");
